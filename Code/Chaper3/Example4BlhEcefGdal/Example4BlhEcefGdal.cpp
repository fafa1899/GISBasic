// Example4BlhEcefGdal.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
    ...
    OGRCoordinateTransformation* gcs2Ecef = OGRCreateCoordinateTransformation(&gcs, &ecef);
    OGRCoordinateTransformation* ecef2Gcs = OGRCreateCoordinateTransformation(&ecef, &gcs);
