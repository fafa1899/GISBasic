...
(function () {
	...
	//建筑物要素
	const buildingLayer = new BuildingLayer(layerGroup, 'public/LosAngelesBuildingEx.gltf');
		...
		renderer.domElement.addEventListener('dblclick', (event) => {
			if (isPickup) {
				...
				if (intersects.length > 0) {
					...
					let requestAddress = 'http://localhost:8000/building/attribute?x=' + utmCoord.x + "&y=" + utmCoord.y;
